...
import getLocalizedValue from "https://framerusercontent.com/modules/btwgalb3LPUfStcPRxFR/uWpHzES7kAKi6sTsX8VF/hB0TZBwj9.js";
const StopScrollFonts = getFonts(StopScroll);
const cycleOrder = ["trwNdV07a", "cG2MUxXhA", "UgaGiYdrx", "inmxqEbMN", "JikoXPFNJ"];
const serializationHash = "framer-fUrQ5";
...
const getProps = ({
    ...
    return { ...props,
        variant: humanReadableVariantMap[props.variant] ? ? props.variant ? ? "trwNdV07a"
    };
};
...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const isDisplayed = () => {
        if (["cG2MUxXhA", "UgaGiYdrx", "inmxqEbMN", "JikoXPFNJ"].includes(baseVariant)) return true;
        return false;
    };
        ...
        children: /*#__PURE__*/ _jsx(Variants, {
            ...
            children: /*#__PURE__*/ _jsx(Transition, {
                ...
                children: /*#__PURE__*/ _jsxs(motion.div, { ...restProps,
                    ...gestureHandlers,
                    className: cx(scopingClassNames, "framer-kfb5av", className, classNames),
                                                ...
                                                children: getLocalizedValue("v1", activeLocale) ? ? /*#__PURE__*/ _jsx(React.Fragment, {
                                                    children: /*#__PURE__*/ _jsx(motion.p, {
                                                        style: {
                                                            ...
                                                            "--framer-line-height": "20px",
                                                            "--framer-text-alignment": "justify",
                                                            "--framer-text-color": "var(--extracted-r6o4lv, rgb(222, 171, 2))"
                                                        },
                                                        children: "+"
                                                    })
                                                }),
...
const css = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-fUrQ5.framer-2j5t1u, .framer-fUrQ5 .framer-2j5t1u { display: block; }", ".framer-fUrQ5.framer-kfb5av { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 800px; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 1440px; }", ".framer-fUrQ5 .framer-l2x49w-container { flex: none; height: auto; position: relative; width: auto; }", ".framer-fUrQ5 .framer-1fgrqsw { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; left: 0px; overflow: visible; padding: 0px; position: absolute; right: 0px; top: 50px; z-index: 10; }", ".framer-fUrQ5 .framer-a2ml35 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; left: 50%; min-height: 73px; min-width: 1440px; overflow: visible; padding: 0px; position: absolute; top: 49%; width: min-content; z-index: 1; }", ".framer-fUrQ5 .framer-u36gn0 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 66px; justify-content: center; left: 50%; min-width: 263px; overflow: hidden; padding: 0px; position: absolute; top: 4%; width: min-content; z-index: 1; }", ".framer-fUrQ5 .framer-1oz0xu8 { align-content: center; align-items: center; bottom: -34px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; left: 0px; min-height: 34px; overflow: visible; padding: 0px; position: absolute; right: 0px; z-index: 1; }", ".framer-fUrQ5 .framer-16xs0l5 { flex: none; height: 34px; left: calc(49.80988593155896% - 263px / 2); position: absolute; top: calc(50.00000000000002% - 34px / 2); width: 263px; z-index: 1; }", ".framer-fUrQ5 .framer-25fezi { align-content: center; align-items: center; bottom: 1px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; height: 36px; justify-content: space-between; left: calc(50.00000000000002% - 263px / 2); overflow: hidden; padding: 0px; position: absolute; width: 263px; z-index: 1; }", ".framer-fUrQ5 .framer-nxjnud { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; left: 0px; min-height: 20px; overflow: visible; padding: 0px; position: absolute; top: -21px; width: 263px; z-index: 1; }", ".framer-fUrQ5 .framer-vmhe03 { -webkit-user-select: none; flex: none; height: auto; left: 21%; position: absolute; top: 50%; user-select: none; white-space: pre; width: auto; z-index: 1; }", ".framer-fUrQ5 .framer-zjjjex { -webkit-user-select: none; flex: none; height: auto; left: 58%; position: absolute; top: 50%; user-select: none; white-space: pre; width: auto; z-index: 1; }", ".framer-fUrQ5 .framer-1yu7n1z { -webkit-user-select: none; flex: none; height: auto; left: 86%; position: absolute; top: 50%; user-select: none; white-space: pre; width: auto; z-index: 1; }", ".framer-fUrQ5 .framer-9npjw { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; left: calc(50.00000000000002% - 100% / 2); overflow: hidden; padding: 0px; position: absolute; top: calc(50.00000000000002% - 100vh / 2); width: 100%; z-index: 0; }", ".framer-fUrQ5 .framer-1ypoxj4 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-fUrQ5 .framer-yk2qnf, .framer-fUrQ5 .framer-pvqgej, .framer-fUrQ5 .framer-1gw5ibv { flex: 1 0 0px; height: 100%; overflow: visible; position: relative; width: 1px; }", ".framer-fUrQ5 .framer-t0meh1 { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-fUrQ5 .framer-1simu2h { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: 16px; justify-content: flex-start; left: -1px; overflow: hidden; padding: 0px; position: absolute; top: -20px; width: 5px; z-index: 1; }", ".framer-fUrQ5 .framer-ysr7w0, .framer-fUrQ5 .framer-116y9x0 { align-content: flex-end; align-items: flex-end; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 100%; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 1px; z-index: 0; }", ".framer-fUrQ5 .framer-ean04y { bottom: 7px; flex: none; height: 9px; left: -6px; position: absolute; right: -6px; z-index: 1; }", ".framer-fUrQ5 .framer-7bxsgv { align-content: center; align-items: center; bottom: -27px; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: 16px; justify-content: flex-start; overflow: hidden; padding: 0px; position: absolute; right: -3px; width: 5px; z-index: 1; }", ".framer-fUrQ5 .framer-wxthlb { flex: none; height: 9px; left: -6px; position: absolute; right: -6px; top: 5px; z-index: 1; }", ".framer-fUrQ5 .framer-1f4xn8e { align-content: flex-end; align-items: flex-end; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-fUrQ5.framer-v-17wy396 .framer-1fgrqsw, .framer-fUrQ5.framer-v-97wzbs .framer-1fgrqsw, .framer-fUrQ5.framer-v-ott8fo .framer-1fgrqsw, .framer-fUrQ5.framer-v-pbknlq .framer-1fgrqsw { top: 0px; }", ".framer-fUrQ5.framer-v-97wzbs .framer-1oz0xu8, .framer-fUrQ5.framer-v-ott8fo .framer-1oz0xu8, .framer-fUrQ5.framer-v-pbknlq .framer-1oz0xu8 { bottom: -1px; }", ".framer-fUrQ5.framer-v-97wzbs .framer-nxjnud, .framer-fUrQ5.framer-v-ott8fo .framer-nxjnud, .framer-fUrQ5.framer-v-pbknlq .framer-nxjnud { bottom: 0px; top: unset; }", ".framer-fUrQ5.framer-v-97wzbs .framer-1simu2h { height: calc(var(--framer-viewport-height, 100vh) * 0.79); top: 0px; }", ".framer-fUrQ5.framer-v-97wzbs .framer-7bxsgv { bottom: 0px; height: calc(var(--framer-viewport-height, 100vh) * 0.79); }", ".framer-fUrQ5.framer-v-ott8fo .framer-yk2qnf, .framer-fUrQ5.framer-v-pbknlq .framer-yk2qnf { flex: none; height: 1px; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: -1px; width: 100%; z-index: 1; }", ".framer-fUrQ5.framer-v-ott8fo .framer-pvqgej { flex: none; height: 1px; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: calc(49.87500000000003% - 1px / 2); width: 100%; z-index: 1; }", ".framer-fUrQ5.framer-v-ott8fo .framer-1gw5ibv, .framer-fUrQ5.framer-v-pbknlq .framer-1gw5ibv { bottom: -1px; flex: none; height: 1px; left: calc(50.00000000000002% - 100% / 2); position: absolute; width: 100%; z-index: 1; }", ".framer-fUrQ5.framer-v-pbknlq .framer-pvqgej { flex: none; height: 1px; left: calc(50.00000000000002% - 61px / 2); position: absolute; top: calc(49.87500000000003% - 1px / 2); width: 61px; z-index: 1; }"];
/**
 * This is a generated Framer component.
 * @framerIntrinsicHeight 800
 * @framerIntrinsicWidth 1440
 * @framerCanvasComponentVariantDetails {"propertyName":"variant","data":{"default":{"layout":["fixed","fixed"]},"cG2MUxXhA":{"layout":["fixed","fixed"]},"UgaGiYdrx":{"layout":["fixed","fixed"]},"inmxqEbMN":{"layout":["fixed","fixed"]},"JikoXPFNJ":{"layout":["fixed","fixed"]}}}
 ...
 */
const FramerhB0TZBwj9 = withCSS(Component, css, "framer-fUrQ5");
export default FramerhB0TZBwj9;
FramerhB0TZBwj9.displayName = "Preloader";
FramerhB0TZBwj9.defaultProps = {
    height: 800,
    width: 1440
};
addPropertyControls(FramerhB0TZBwj9, {
    variant: {
        options: ["trwNdV07a", "cG2MUxXhA", "UgaGiYdrx", "inmxqEbMN", "JikoXPFNJ"],
        optionTitles: ["Slide1 (invisible)", "Slide2", "Slide3", "Slide4", "Slide5"],
        title: "Variant",
        type: ControlType.Enum
    }
});
addFonts(FramerhB0TZBwj9, [{
    explicitInter: true,
    fonts: [{
        family: "Inter",
        source: "framer",
...
//# sourceMappingURL=./hB0TZBwj9.map